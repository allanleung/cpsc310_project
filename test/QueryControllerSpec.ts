...
describe("QueryController.executeQuery", () => {
    ...
    it('should not be able to perform a query before any datasets are added', () => {
        const emptyDataController = new DataController();
        const emptyQueryController = new QueryController(emptyDataController);

        return expect(emptyQueryController.executeQuery(new Query(
            {
                IS: {
                    courses_title: "hong kong cinema"
                }
    ...
    it('should not be able to perform a query before after removing a dataset', () => {
        const emptyDataController = new DataController();
        const emptyQueryController = new QueryController(emptyDataController);

        emptyDataController.addDataset('courses', [
            {
                courses_title: "hong kong cinema",
                courses_uuid: 39426,
                courses_instructor: "bailey, c. d. alison",
        ...
        emptyDataController.removeDataset('courses');
